...
@push('scripts')
    ...
    <script>
        ...
        function create() {
            ...
            method = 'POST';
            $('.modal-header h5').html("Tambah Role");
        ...
        function edit(id) {
            ...
            $.get(editUrl, function(res){
                $('.modal-header h5').html("Edit Role");
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-primary float-right" onclick="create()"><i class="icon-plus mr-1"></i> Role</button>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" id="Name" class="form-control" name="name" placeholder="Nama Role" required>
                        </div>
                </div>
