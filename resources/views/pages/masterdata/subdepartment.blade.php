...
@section('title', 'Sub Departements')
@push('css')
...
@push('scripts')
    ...
    <script>
        ...
        var Table = $('#daTable').DataTable({
            ajax: "{{ route('subdepartment.index') }}",
            processing: true,
            serverSide: true,
            responsive: true,
            responsive: true,
        ...
        function create() {
            ...
            method = 'POST';
            $('.modal-header h5').html("Tambah Sub Departemen");
            $('#basicModal').modal('show');
        }

        function edit(id) {
            let editUrl = "{{ route('subdepartment.edit', ':id') }}";
            editUrl = editUrl.replace(':id', id);
            url = "{{ route('subdepartment.update', ':id') }}";
            url = url.replace(':id', id);
            method = "POST";
            $('.modal-body form').append('<input type="hidden" name="_method" value="PUT" />');
            $.get(editUrl, function(res){
                $('.modal-header h5').html("Edit Sub Departemen");
        ...
        function destroy(id) {
            let deleteUrl = "{{ route('subdepartment.destroy', ':id') }}";
                ...
                <div class="col-12 m-b-30">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Sub Departemen Table</h5>
                                    <button class="btn btn-primary float-right" onclick="create()"><i class="icon-plus mr-1"></i> Sub Departemen</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="Nama">Sub Departemen</label>
                            <input type="text" id="Nama" class="form-control" name="nama" placeholder="Nama Sub Departemen" required>
                        </div>
                </div>
