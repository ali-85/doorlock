...
@push('scripts')
    ...
    <script>
        ...
        function edit(id) {
            let editUrl = "{{ route('location.edit', ':id') }}";
        ...
        function destroy(id) {
            let deleteUrl = "{{ route('location.destroy', ':id') }}";
                ...
                <div class="col-12 m-b-30">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Data Location Table</h5>
                                    <button class="btn btn-primary float-right" onclick="create()"><i class="icon-plus mr-1"></i> Data Location</button>
