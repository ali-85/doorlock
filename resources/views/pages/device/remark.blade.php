...
@push('scripts')
    ...
    <script>
        ...
        function create() {
            ...
            method = 'POST';
            $('.modal-header h5').html("Tambah Remark");
            $('#basicModal').modal('show');
        }

        function edit(id) {
            let editUrl = "{{ route('remark.edit', ':id') }}";
            editUrl = editUrl.replace(':id', id);
            url = "{{ route('remark.update', ':id') }}";
            url = url.replace(':id', id);
            method = "POST";
            $('.modal-body form').append('<input type="hidden" name="_method" value="PUT" />');
            $.get(editUrl, function(res){
                $('.modal-header h5').html("Edit Remark");
        ...
        function destroy(id) {
            let deleteUrl = "{{ route('remark.destroy', ':id') }}";
        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Remark</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                ...
                <div class="col-12 m-b-30">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Remark Table</h5>
                                    <button class="btn btn-primary float-right" onclick="create()"><i class="icon-plus mr-1"></i> Remark</button>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="form-group">
                            <label>Remark</label>
                            <input type="text" class="form-control" name="name" placeholder="Remark" required>
                        </div>
                </div>
